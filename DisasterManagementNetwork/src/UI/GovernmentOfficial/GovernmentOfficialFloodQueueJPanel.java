 ...
 * @author moins
 */
public class GovernmentOfficialFloodQueueJPanel extends javax.swing.JPanel {
     ...
     */
    public GovernmentOfficialFloodQueueJPanel(JPanel userProcessContainer, UserAccount userAccount, Enterprise enterprise, OrganizationDirectory directory) {
        initComponents();
    ...
    public void populateTable(){
        ...
        for (WorkRequest wr : organization.getWorkQueue().getWorkRequestList()) {
            ...
            {                
                ...
                if(gov_wrs.getFloodSensor() != null)
                {
    ...
    private void btnResolveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResolveActionPerformed
        ...
        citizenWorkRequest.setFloodSensor(request.getFloodSensor());
        citizenWorkRequest.setFloodMessage("Area-code "+request.getFloodSensor().getZipcode()+"is relieved from Flood.");
    ...
    private void btnAlertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlertActionPerformed
        ...
        citizenWorkRequest.setFloodSensor(request.getFloodSensor());
        citizenWorkRequest.setFloodMessage("Area-code "+request.getFloodSensor().getZipcode()+" is flooded! Please avoid this area until further notice");
        citizenWorkRequest.setSender(userAccount);
        citizenWorkRequest.setStatus("Message Sent to Citizens");
